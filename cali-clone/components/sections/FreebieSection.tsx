    ...
    <section className="container-x" style={{ padding: "120px 0" }}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div ref={txt as React.Ref<HTMLDivElement>} className="flex flex-col gap-5 max-w-[480px]">
          <span className="fu eyebrow-italic">let&apos;s connect</span>
          <span className="fu eyebrow">Get in Touch</span>
          <h2 className="fu" style={{ fontSize: "clamp(36px, 5vw, 72px)" }}>Sounds Good? Let&apos;s connect</h2>
          <h3 className="fu" style={{ fontSize: 26, fontStyle: "italic" }}>
          ...
          <form ref={formRef as React.Ref<HTMLFormElement>} onSubmit={onSubmit} className="fu flex flex-col gap-5 mt-2">
            ...
            <button type="submit" className="pill pill-filled self-start">Send Message</button>
            {state === "ok" && <p style={{ color: "var(--color-accent-2)", fontSize: 14 }}>Thank you! I&apos;ll be in touch shortly.</p>}
